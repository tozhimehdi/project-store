...
<ul class="menu-inner py-1">
  ...
  <!-- management -->
  <li class="menu-header small text-uppercase"><span class="menu-header-text"> مدیریت </span></li>
    ...
    <ul class="menu-sub">
              <li class="menu-item">
        <a href="" class="menu-link">لیست کاربران</a>
      </li>
        <li class="menu-item">
        <a href="" class="menu-link">ایجاد کاربر</a>
      </li>

        <li class="menu-item">
        <a href="" class="menu-link">ویرایش کاربر</a>
      </li>
  ...
  <li class="menu-item">
    ...
    <ul class="menu-sub">
      <li class="menu-item">
        <a href="app-access-roles.html" class="menu-link">
          <div data-i18n="Article Comments"> نطرات مقاله</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="app-access-permission.html" class="menu-link">
          <div data-i18n="Product Comments"> نطرات محصول</div>
        </a>
      </li>
    </ul>
  </li>
  ...
  <li class="menu-item">
    ...
    <ul class="menu-sub">
      <li class="menu-item">
        <a href="app-access-roles.html" class="menu-link">
          <div data-i18n="Products List">لیست محصولات</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="app-access-permission.html" class="menu-link">
          <div data-i18n="Create Product">ایجاد محصول جدید</div>
        </a>
      </li>
    </ul>
  </li>
  ...
  <li class="menu-item">
    ...
    <ul class="menu-sub">
      <li class="menu-item">
        <a href="app-access-roles.html" class="menu-link">
          <div data-i18n="Orders List">لیست سفارشات</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="app-access-permission.html" class="menu-link">
          <div data-i18n="Create Order">ایجاد مقاله جدید</div>
        </a>
      </li>
    </ul>
  </li>
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      ...
      <div data-i18n="Discount Code">کد تخفیف </div>
    </a>
    <ul class="menu-sub">
      <li class="menu-item">
        <a href="app-access-roles.html" class="menu-link">
          <div data-i18n="Discount Codes List">لیست کد‌های تخفیف</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="app-access-permission.html" class="menu-link">
          <div data-i18n="Create New Discount Code">ایجاد کد تخفیف جدید</div>
        </a>
      </li>
    </ul>
  </li>
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-wallets"></i>
      <div data-i18n="Payment">پرداخت ها </div>
    </a>
    <ul class="menu-sub">
      <li class="menu-item">
        <a href="app-access-roles.html" class="menu-link">
          <div data-i18n="Payments List">لیست پرداختی ها</div>
        </a>
      </li>
  ...
  <li class="menu-item">
    <a href="app-email.html" class="menu-link">
      ...
      <div data-i18n="Newsletter Members">اعضای خبرنامه</div>
    </a>
  </li>
  <li class="menu-item">
    <a href="app-email.html" class="menu-link">
      <i class="menu-icon tf-icons bx bx-cog"></i>
      <div data-i18n="Site Settings"> تنظیمات سایت</div>
    </a>
  </li>
  <li class="menu-item">
    <a href="app-email.html" class="menu-link">
      <i class="menu-icon tf-icons bx bx-layout"></i>
      <div data-i18n="Theme Settings"> تنظیمات قالب</div>
    </a>
  </li>
  <li class="menu-item">
    <a href="app-email.html" class="menu-link">
      <i class="menu-icon tf-icons bx bx-business"></i>
      <div data-i18n="Business Info"> اطلاعات کسب‌وکار</div>
    </a>
  </li>
